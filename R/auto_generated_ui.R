# Code generated by parse_ui_table.R, Tue Jun 20 14:56:27 2023
...
auto_generated_ui <- function(...) {
  ...
  tabsetPanel( ... ,
    ...
    tabPanel(title = "Cancer Growth",
      ...
      sliderInput("log_norm_mean", "Tumour growth rate mean (lognormal) (\u03b1\u2081) [1/yr]", step = 0.01, value = 1.07, min = 0.8, max = 1.4),
      sliderInput("log_norm_sd", "Tumour growth rate SD (\u03b1\u2082) [1/yr]", step = 0.01, value = 1.31, min = 0.9, max = 1.7),
      # Fixed
    ...
    tabPanel(title = "Screening",
      ...
      sliderInput("beta_1", "Sensitivity of mammography (\u03b2\u2081) [mm] \u2014 how rapidly sensitivity changes with tumour size", step = 0.01, value = 1.47, min = 1, max = 1.8),
      sliderInput("beta_2", "Sensitivity of mammography (\u03b2\u2082) [mm] \u2014 size of tumour for which sensitivity is equal to 50%.", step = 0.05, value = 6.5, min = 5, max = 8),
      # Fixed
