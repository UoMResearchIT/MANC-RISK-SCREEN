# Code generated by parse_ui_table.R, Mon Apr 17 21:31:11 2023
...
class = "numeric") ),
  ...
  fluidRow(
    ...
    column(width=NCOL, numericInput("cost_follow_up", "Cost of follow up", value = 106, min = 0, max = 500) ),
    column(width=NCOL, numericInput("cost_biop", "Cost of biopsy", value = 290, min = 0, max = 1000) ),
