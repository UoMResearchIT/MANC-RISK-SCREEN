# Code generated by parse_ui_table.R, Fri May 19 15:27:21 2023
...
class = "numeric") ),
    ...
    column(width=NCOL, numericInput("log_norm_mean", "Tumour growth rate mean (lognormal)", value = 1.07, min = 0.8, max = 1.2) ),
  ...
  h2("Cost data"),
  fluidRow(
    column(width=NCOL, sliderInput("cost_strat", "Cost of stratification process", value = 8.45, min = 0, max = 200) ),
    column(width=NCOL, sliderInput("costvar", "Multiplier for Cost of Cancer treatment", step = 0.01, value = 0.1, min = 0, max = 10) ),
    column(width=NCOL, sliderInput("costscreen", "Cost of screening", value = 60.56, min = 0, max = 200) ),
    column(width=NCOL, sliderInput("cost_follow_up", "Cost of follow up", value = 106, min = 0, max = 500) ),
    column(width=NCOL, sliderInput("cost_biop", "Cost of biopsy", value = 290, min = 0, max = 1000) ),
    column(width=NCOL, numericInput("cost_DCIS", "Cost of treating ductal carcinoma in situ", value = 9840, min = 0, max = 50000) ),
    column(width=NCOL, sliderInput("cost_US", "Cost of ultrasonography", value = 52, min = 0, max = 200) ),
    column(width=NCOL, sliderInput("cost_MRI", "Cost of MRI", value = 114, min = 0, max = 500) ),
