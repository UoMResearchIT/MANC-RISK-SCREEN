# Code generated by parse_ui_table.R, Mon Apr 24 15:11:51 2023
...
class = "numeric") ),
  ...
  fluidRow(
    ...
    column(width=NCOL, numericInput("cost_US", "Cost of ultrasonography", value = 52, min = 0, max = 200) ),
    column(width=NCOL, numericInput("cost_MRI", "Cost of MRI", value = 114, min = 0, max = 500) ),
